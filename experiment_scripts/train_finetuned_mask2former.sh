#block(name=finetune_m2f,threads=8,gpus=1,memory=10000,hours=6, subtasks=320)
  ...
  --log-dir "/scratchdata/csmitt/bup20_nerf_inference/camplete_dataset_mask2former_finetuned"\
