...
from .agrobot_base import SB20SequenceDataset
...
class SB20(DatasetFormatBase):
    ...
    def load_data(root, split='train', bg_color='white', mip=None,
        ...
        data = SB20SequenceDataset(root / 'SB_20.json',
                                       subset=split,
                                       seq_num_frames=60,
                                       odom_src=pose_src,
        ...
        modes.update({"masks": masks, "rays": rays, "cameras": cameras, "cameras_ts":poses_ts, "base_rays":base_rays})
